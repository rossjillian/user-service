"""
Original Author: Donald Ferguson
Adapted by Derek Wacks and Jillian Ross

dbutils.py
Helper code for RDSDataTable.py
"""
...
def numbers_to_clause(limit, offset):
...
def create_select(table_name, template, fields=None, order_by=None, limit=None, offset=None, is_select=True):
    ...
    if is_select:
        page = numbers_to_clause(limit, offset)
        sql = "select " + field_list + " from " + table_name + " " + page + " " + w_clause
    else:
